...
# Quant helpers now live in tradingagents/portfolio/quant.py. We re-import them
# at module scope so route code below + monkeypatching tests keep working as
# attribute lookups on this module.
from tradingagents.portfolio.quant import (  # noqa: E402
    RISK_FREE_RATE_ANNUAL,
    RISK_BUDGET_PER_POSITION_PCT,
    CONCENTRATION_TICKER_MAX_PCT,
    CONCENTRATION_SECTOR_MAX_PCT,
    CONCENTRATION_OWNER_MAX_PCT,
    _RETURNS_CACHE,
    _ADV_CACHE,
    _fetch_returns_matrix,
    _fetch_avg_dollar_volume,
    _compute_portfolio_risk,
    _compute_vol_targets,
    _compute_rating_calibration,
